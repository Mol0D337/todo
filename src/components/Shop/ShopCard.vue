      ...
      <a href="#" class="product__image">
        <div class="product__switch image-switch" >
          <div class="image-switch__item" >
            <div class="image-switch__img"><img src="../../assets/image/macbook.jpg" alt="Макбук"></div>
          </div>
          <div class="image-switch__item" >
            <div class="image-switch__img"><img src="../../assets/image/macbook-2.jpg" alt="Макбук"></div>
          </div  >
          <div class="image-switch__item" >
            <div class="image-switch__img"><img src="../../assets/image/macbook-3.jpg" alt="Макбук"></div>
          </div>
        </div>
